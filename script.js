...
var gardenMarker = L.marker([37.006625, -122.042020], { icon: gardenIcon }).addTo(map);
...
meadowMarker.on('click', function() {
  descriptionContainer.innerHTML = "<h2>Location</h2><p>The Cowell Haunted Meadow is below the Cowell college near the fire road.  There have been many claims that a sort of ghost wanders this area on occasion.</p><h2>Lore</h2><p>  The ghost that has been reportedly haunting the grounds is that of Sarah Agnes Cowell.  According to the tale of her death, she passed by being hurled from her buggy due to the horse taking off unexpectedly.</p>";
  descriptionContainer.style.display = 'block'; // Show the description container
  mapContainer.style.display = 'none'; // Hide the map
  homepageButton.style.display = 'block'; // Show the "Homepage" button
  guideText.style.display = 'none'; // hide map guiding description
...
sammyMarker.on('click', function() {
  descriptionContainer.innerHTML = "<h2>Best Banana Slug Spots</h2><p>There are a few areas around campus that ensure a higher probability of spotting banana slugs.</p><h2>Lore</h2><p>There is a strong connection between the students and their mascot the banana slug.  The history of making it the face of UCSC is an interesting one.  The administration was pushing for the sea lion to be UCSC’s mascot, but the students overwhelmingly advocated for Sammy the Slug; the students won.</p>";
  descriptionContainer.style.display = 'block'; // Show the description container
  mapContainer.style.display = 'none'; // Hide the map
  homepageButton.style.display = 'block'; // Show the "Homepage" button
  guideText.style.display = 'none'; // hide map guiding description
