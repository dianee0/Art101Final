...
sammyMarker.on('click', function() {
  descriptionContainer.innerHTML = "<img src='img/sammy.png' width='20%' style='display: block; margin: 0 auto;'><h2>Best Banana Slug Spots</h2><p>The lush and diverse natural surroundings of the University of California, Santa Cruz (UCSC) campus create several ideal habitats for banana slugs, making it easier to spot these fascinating creatures.  Banana slugs are most active during the wetter months, so visiting these areas after rainfall or during the cooler seasons can increase your chances of encountering them. However, please ensure that you respect these creatures' natural habitats and avoid disturbing them or their surroundings while observing them in the wild.</p><h2>Lore</h2><p>There is a strong connection between the students and their mascot the banana slug.  The history of making it the face of UCSC is an interesting one.  The administration was pushing for the sea lion to be UCSC’s mascot, but the students overwhelmingly advocated for Sammy the Slug; the students won.</p><img src='places/slug01.jpg' width='60%'><img src='places/slug02.jpg' width='60%'>";
  descriptionContainer.style.display = 'block'; // Show the description container
  mapContainer.style.display = 'none'; // Hide the map
  homepageButton.style.display = 'block'; // Show the "Homepage" button
  guideText.style.display = 'none'; // hide map guiding description
